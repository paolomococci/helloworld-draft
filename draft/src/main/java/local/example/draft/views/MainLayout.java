package local.example.draft.views;
...
import local.example.draft.security.AuthenticatedUser;
import local.example.draft.views.hello.HelloView;
import local.example.draft.views.home.HomeView;
